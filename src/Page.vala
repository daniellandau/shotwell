...
public abstract class CheckerboardPage : Page {
    ...
    protected override bool key_press_event(Gdk.EventKey event) {
        ...
        switch (Gdk.keyval_name(event.keyval)) {
            ...
            case "space":
                Marker marker = get_view().mark(get_view().get_cursor_view());
    ...
    public void move_cursor(CompassPoint point) {
        ...
        if (cursor == null && get_view().get_cursor_view() == null) {
        ...
        if (cursor == null) {
            cursor = get_view().get_cursor_view() as CheckerboardItem;
        }
